...
@class IFlyMscSynthesizer, IFlyTTSParam, NSDictionary, NSString;
...
+ (_Bool)destroy;
+ (id)sharedInstance;
@property(retain) IFlyTTSParam *sessionConfig; // @synthesize sessionConfig=_sessionConfig;
