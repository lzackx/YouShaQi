...
@class NSArray, NSMutableDictionary, NSString, _priv_NBSSafeMutableArray;

@interface _priv_NBSTraceItem : NSObject
{
    ...
    int cpu_1;
    int cpu_2;
    _priv_NBSSafeMutableArray *subList;
...
@property(readonly) _priv_NBSSafeMutableArray *subList; // @synthesize subList;
