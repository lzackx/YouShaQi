...
@class IMInterstitialAdUnit, NSDictionary, NSString;
@protocol IMInterstitialDelegate;

@interface IMInterstitial : NSObject <IMInterstitialAdUnitDelegate>
{
    _Bool _readyCallbackGiven;
...
@property _Bool readyCallbackGiven; // @synthesize readyCallbackGiven=_readyCallbackGiven;
