...
@class IMAdCloseButton, IMAdsConfig, IMExpandProperties, IMMediaManager, IMOrientationProperties, IMRenderViewController, IMRenderViewGestureRecognizer, IMResizeProperties, IMRichMediaResolver, NSString, UIWebView;
@protocol IMRenderViewDelegate, IMRenderViewDismissDelegate;

@interface IMRenderView : UIView <UIGestureRecognizerDelegate, UIWebViewDelegate, IMRenderViewDelegate, IMRichMediaDelegate>
{
    _Bool _launched;
