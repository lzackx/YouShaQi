...
@property(nonatomic) GDTMobBannerView *bannerView; // @synthesize bannerView=_bannerView;
@property(nonatomic) id <GDTMobBannerViewDelegate> delegate; // @synthesize delegate=_delegate;
