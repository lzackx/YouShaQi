#line 1 "/Users/lzackx/Downloads/Reverse/Operation/YouShaQi/YouShaQiDylib/Logos/YouShaQiDylib.xm"
...
#line 17 "/Users/lzackx/Downloads/Reverse/Operation/YouShaQi/YouShaQiDylib/Logos/YouShaQiDylib.xm"
...
static void _logos_method$_ungrouped$__NSCFString$replaceCharactersInRange$withString$(_LOGOS_SELF_TYPE_NORMAL __NSCFString* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, NSRange range, NSString * aString) {
    ...
    if (range.length > aString.length ) {
        ...
        _logos_orig$_ungrouped$__NSCFString$replaceCharactersInRange$withString$(self, _cmd, range, aString);
        return;
    }
    _logos_orig$_ungrouped$__NSCFString$replaceCharactersInRange$withString$(self, _cmd, range, aString);
}
